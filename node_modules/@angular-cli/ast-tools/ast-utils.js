...
function _addSymbolToNgModuleMetadata(ngModulePath, metadataField, symbolName, importPath) {
    ...
    return metadata
        ...
        var importInsert = route_utils_1.insertImport(ngModulePath, symbolName, importPath);
...
*/
function addComponentToModule(modulePath, classifiedName, importPath) {
    return _addSymbolToNgModuleMetadata(modulePath, 'declarations', classifiedName, importPath);
}
exports.addComponentToModule = addComponentToModule;
/**
...
//# sourceMappingURL=/Users/hans/Sources/angular-cli/packages/ast-tools/src/ast-utils.js.map